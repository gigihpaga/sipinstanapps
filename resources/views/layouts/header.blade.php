         ...
         <div class="header-content">
                     ...
                     <li class="menu-content ps-menu">
                         <a href="#">
                             <div class="message-image">
                                 <img src="{{ asset('arfa/assets/images/avatar1.png') }}" class="rounded-circle w-100"
                                     alt="user1">
                             </div>
                             <div class="message-content read">
                                 <div class="subject">John</div>
                                 <div class="body">Please call me at 9pm</div>
                                 <div class="time">Just now</div>
                             </div>
                         </a>
                         <a href="#">
                             <div class="message-image">
                                 <img src="{{ asset('arfa/assets/images/avatar2.png') }}" class="rounded-circle w-100"
                                     alt="user1">
                             </div>
             ...
             <div class="dropdown dropdown-menu-end">
                 <a href="#" class="user-dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                     ...
                     <img class="img-user" src="{{ asset('arfa/assets/images/avatar1.png') }}"
                         alt="user"srcset="">
                 </a>
