                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Data Pangkat Golongan</h5>
                        </div>
                        <div class="card-body">
                            {{-- <canvas id="myChart" height="642" width="1388"></canvas> --}}
                            {{-- auth()->user()->can('create_master/pangkat_golongan') --}}
                            @if (request()->user()->can('create_master/pangkat_golongan'))
...
@push('js_page')
   <script>
        ...
        $('.btn-add').on('click', function() {
            ...
            $.ajax({
                type: "GET",
                url: `{{ url('master/pangkat_golongan/create') }}`,
                // data: "data",
                // dataType: "dataType",
        ...
        $('#role-table').on('click', '.btn-action', function() {
            ...
            if (typeaction == 'delete') {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: "DELETE",
                            url: `{{ url('master/pangkat_golongan') }}/${id}`,
                            headers: {
            ...
            $.ajax({
                type: "GET",
                url: `{{ url('master/pangkat_golongan') }}/${id}/edit`,
                // data: "data",
                // dataType: "dataType",
                success: function(resHtlm) {
                    // set content modal from response
