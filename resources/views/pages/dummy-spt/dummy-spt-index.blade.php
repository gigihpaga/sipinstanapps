...
@push('js_page')
    <script>
        ...
        $('#role-table').on('click', '.btn-action', function() {
            ...
            $.ajax({
                ...
                success: function(resHtlm) {
                    ...
                    handleActionSubmit()
                    // ================================ NEW CODE =====================================
                    $('#btn_save_x').on('click', function() {
                        console.log('btn save clik')
                        let formTarget = $('#form-action');
                        dynamicSubmit(formTarget);
                    })
                    // ================================ NEW CODE =====================================
                }
            });
        ...
        // ================================ NEW CODE =====================================
        function dynamicSubmit(formTarget) {
