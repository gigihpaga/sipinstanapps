...
class DummySptDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\Spt $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Spt $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('DT_RowIndex')->title('No')->searchable(false)->orderable(false)
                ->width(20), // untuk no
            Column::make('pka_id'),
            Column::make('pemohon_spt'),
            Column::make('sifat_tugas'),
            Column::make('status_buat'),
            Column::make('nomor_pengajuan'),
            Column::make('tanggal_mulai'),
            Column::make('tanggal_selesai'),
            Column::make('keperluan_tugas'),
            Column::make('keterangan_tugas'),
            Column::make('note'),
