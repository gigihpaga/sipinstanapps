...
class PangkatGolonganDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                $action = '';
                if (Gate::allows('update_master/jabatan')) {
                ...
                if (Gate::allows('delete_master/jabatan')) {
     ...
     *
     * @param \App\Models\PangkatGolongan $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(PangkatGolongan $model): QueryBuilder
    {
    ...
    {
        return 'PangkatGolongan_' . date('YmdHis');
    }
}
